...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_M1.read( "groundMPC_data_acadodata_M1.txt" );
    BMatrix acadodata_M2;
    acadodata_M2.read( "groundMPC_data_acadodata_M2.txt" );
    ...
    acadodata_f3 << dot(x) == v;
    acadodata_f3 << dot(v) == u;
    acadodata_f3 << dot(th) == uth;
    ...
    uint export_flag;
    export_flag = ExportModule1.exportCode( "ground_MPC" );
