...
{
int dummy;
/** Matrix of size: 11 x 18 (row major format)
 * 
...
/** Matrix of size: 11 x 9 (row major format)
 * 
 ...
 * 
 *  Matrix containing 10 reference/measurement vectors of size 19 for first 10 nodes.
 */
real_t y[ 190 ];
...
real_t rk_diffsPrev2[ 432 ];

/** Matrix of size: 18 x 24 (row major format) */
real_t rk_diffsNew2[ 432 ];

/** Row vector of size: 465 */
real_t state[ 465 ];
...
/** Matrix of size: 180 x 19 (row major format) */
real_t Q2[ 3420 ];

/** Matrix of size: 60 x 6 (row major format) */
real_t R1[ 360 ];

/** Matrix of size: 60 x 19 (row major format) */
real_t R2[ 1140 ];

/** Matrix of size: 18 x 18 (row major format) */
real_t QN1[ 324 ];

/** Matrix of size: 18 x 13 (row major format) */
real_t QN2[ 234 ];
...
/** Matrix of size: 18 x 6 (row major format) */
real_t W1[ 108 ];

/** Matrix of size: 18 x 6 (row major format) */
real_t W2[ 108 ];

/** Matrix of size: 990 x 6 (row major format) */
real_t E[ 5940 ];
