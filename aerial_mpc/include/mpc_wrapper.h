...
public:
	...
	void setEnabled (const std::string &val, bool enabledMsg);

	// Static callbacks
	static void inputCallback (const mpc_wrapper::InputDataMsg &inputDataMsg);
	static void enableCallback (const std_msgs::String &inputDataMsg);
	static void disableCallback (const std_msgs::String &inputDataMsg);
};
